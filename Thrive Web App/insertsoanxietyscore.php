...
$insertquery = $insertquery = "INSERT INTO socanxscore(socialanxietyscore, UserID) VALUES('$newsoanxscore', '$userID')"
        . " ON DUPLICATE KEY UPDATE socialanxietyscore = '$newsoanxscore' "; 

$result1 = mysqli_query($conn, $insertquery) or die(mysqli_error($conn));
            ...
            *********************************************************************************************************************************************************** -->
            ...
            <section id="main-content">
                <section class="wrapper site-min-height">
                    ...
                    <?php echo 'Social Anxiety Score updated' ?>
