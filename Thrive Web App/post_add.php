            ...
            *********************************************************************************************************************************************************** -->
            ...
            <section id="main-content">
                <section class="wrapper site-min-height">
                    <h3><i class="fa fa-angle-right"></i> Add Your Post</h3>
                    <div class="row mt">
                        <div class="col-lg-12">
...
// post_add.php
                            if (!empty($_POST)) {
                                ...
                                //This function Inserts the posts into the database, You can then view the post based off the assigned ID
                                // The UserID is taken from the Session variable and inserted allocating the post to the current User.
