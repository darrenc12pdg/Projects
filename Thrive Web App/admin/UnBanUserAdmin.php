...
$unbanuser = "UPDATE tblUserAccount SET banned = 0 WHERE id = '$userid'";


$resultban = mysqli_query($conn, $unbanuser) or die(mysqli_error($conn));
?>
            ...
            *********************************************************************************************************************************************************** -->
            ...
            <section id="main-content">
                <section class="wrapper site-min-height">
                    <h3><i class="fa fa-angle-right"></i> User has been Un-banned </h3>
                    <div class="row mt">
                        <div class="col-lg-12">
                            <p></p>
                        </div>
