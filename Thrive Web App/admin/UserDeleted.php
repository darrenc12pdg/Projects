...
$id = htmlentities($_POST['deleteuser']);

$delete = "DELETE FROM tblUserAccount WHERE id= '$id'";
mysqli_query($conn, $delete);
mysqli_close($conn);
// Query deletes users from database
            ...
            *********************************************************************************************************************************************************** -->
            ...
            <section id="main-content">
                <section class="wrapper site-min-height">
                    <h3><i class="fa fa-angle-right"></i> User has been successfully deleted</h3>
                    <div class="row mt">
                        <div class="col-lg-12">
                            <p><a href="userAuthorized.php">Return to user management</p>
                        </div>
                    </div>
