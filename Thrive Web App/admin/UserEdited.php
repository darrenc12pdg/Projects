...
$password = htmlentities($_POST['passid']);
$fname = htmlentities($_POST['fid']);
$sname = htmlentities($_POST['sid']);
$add1 = htmlentities($_POST['add1id']);
$add2 = htmlentities($_POST['add2id']);
$pcode = htmlentities($_POST['pcodeid']);
$city = htmlentities($_POST['cityid']);
$country = htmlentities($_POST['countryid']);
$telnum = htmlentities($_POST['telnumid']);

$query1 = "UPDATE tblUserAccount SET Email ='$email', Password = '$password', Firstname = '$fname', Surname = '$sname', Add1 = '$add1', Add2 = '$add2', City = '$city', Postcode = '$pcode', Country = '$country', TelNo = '$telnum' WHERE id = '$userid'";
$result = mysqli_query($conn, $query1) or die(mysqli_error($conn));
// This Update Query edits users details 
mysqli_close($conn);
?>
            ...
            *********************************************************************************************************************************************************** -->
            ...
            <section id="main-content">
                <section class="wrapper site-min-height">
                    <h3><i class="fa fa-angle-right"></i> User has been edited </h3>
                    <div class="row mt">
                        <div class="col-lg-12">
                            <p></p>
                        </div>
