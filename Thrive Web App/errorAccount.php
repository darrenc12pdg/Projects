...
<html lang="en">
  ...
  <center><h5 style='color:red'>Error: <?php echo implode(" ",$error)?>.</h5><br> 
                <p>Please click below to return to your account and try again</p><br>
      ...
      <footer class="site-footer">
          <div class="text-center">
              Thrive Web App 2019
              <a href="errorAccount.php" class="go-top">
